...
public class OptionPanel extends UIElement
{
    ...
    public OptionPanel(Handler handler, String[] options, int x, int y, int bWidth, int bHeight, int panelWidth, int choiceAmount)
    {
        super(handler);
        ...
        {
            buttons[i] = new Button(handler, x+(i%panelWidth)*bWidth, y+(i/panelWidth)*bHeight, bWidth, bHeight, options[i]);
        }
